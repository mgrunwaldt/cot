...
<html>
    <head>
        ...
        <link href="/css/layouts/mainMobile.css" rel="stylesheet" type="text/css">

        <script src="/js/jquery/jquery.js"></script>
        <script src="/js/jquery/jquery-ui.js"></script>
        <script type="text/javascript" src="/js/tools.js"></script>
        <script type="text/javascript" src="/js/layouts/mainMobile.js"></script>
    </head>
    ...
    <body class="font1">
        ...
        <div id="header" >
            <div id="headerContainer">
                ...
                <div class="centeredContent" style="overflow:visible">
                    <div id="headerSuperiorMenu" class="font1">
                        ...
                        <img id="coverMenuIcon" src="/files/layouts/menuIcon.png" alt="menu icon"/>
                    </div>
                    <div id="headerSuperiorDesplegableMenu">
                        <div class="headerSuperiorMenuRow" href="about">
                            <div id="aboutMenu" class="menuTitle font6 color2" href="about">ABOUT</div>
                        </div>
                        <img class="menuSep" src="/files/layouts/separator.png" alt="menu icon"/>
                        <div class="headerSuperiorMenuRow" href="portfolio">
                            <div id="portfolioMenu" class="menuTitle font6 color2" href="about">PORTFOLIO</div>
                        </div>
                        <img class="menuSep" src="/files/layouts/separator.png" alt="menu icon"/>
                        <div class="headerSuperiorMenuRow" href="contact">
                            <div id="contactMenu" class="menuTitle font6 color2" href="about">CONTACT</div>
                        </div> 
                    </div>
                </div>
            </div>
        ...
        <div id="footer">
            <div id="footerContainer">
                <div class="centeredContent">
                    <div id="footerCol3">
                        ...
                        <div id="contactSend" class="font1">
                            Enviar
                        </div>
                    </div>
                    <div id="footerCol1">
                        <div class="footerRow1 font1 color2">MONTEVIDEO - URUGUAY</div>
                        <div class="footerRow2 font2 color2">Vazquez Ledesma 2983</div>
                        <div class="footerRow3 font2 color2">Tel.: (+598) 99 875 994</div>
                        <div class="footerRow4 font2 color2">contacto@roberto.uy</div>
                        <br /> 
                    </div>
            ...
            <div id="footerInferiorBar">
                <div id="footerInferiorBarCol1" class="font5 color2">Roberto.uy ©2016. All rights reserved.</div>
            </div>
        </div>
