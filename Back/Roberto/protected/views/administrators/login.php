...
<body class="backgroundColor4 color1 font1">	
    <div id="content">
            <img id="logo" src="/files/administrators/logo.png"/>
        <div id="signInLine" class="backgroundColor7"></div>
        <div id="emailDiv">
        ...
        <div id="signIn" class="backgroundColor7 font2 color2">INICIAR SESIÓN</div>
        <div id="signInLine" class="backgroundColor7"></div>
    </div>
    <div id="poweredBy">
        <div id="poweredByText" class="font2">Powered by:</div>
        <img id="moonLogo" src="/files/layouts/moonLogo.png">
    </div>
    ...
    <div id="alertMessageFixedContainer">
        <div id="alertMessageDivContainer">
            ...
            <div id="alertMessageDiv">
                ...
                <div id="alertMessageClose" class="alertMessageClose" style="background-color: grey;">X</div>
                <div id="alertMessageMessage" class="font2 color1"></div>
                <div id="alertMessageAceptar" style=>ACEPTAR</div>
            </div>
        </div>
    </div>
</body>
